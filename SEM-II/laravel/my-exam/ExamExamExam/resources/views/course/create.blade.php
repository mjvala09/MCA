  ...
  <body>
    ...
    <form action="{{ route('student.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="exampleFormControlInput1" name="contact" placeholder="Enter contact">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">COURSE : </label>
            <input type="text" class="form-control" id="exampleFormControlInput1" name="course" placeholder="Enter course">
        </div>
